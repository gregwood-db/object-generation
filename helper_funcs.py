...
def createDashboard(w):
    ...
    # create a dashboard with a standard layout
    dash_id = str(uuid.uuid4())
    content = '{"datasets":[{"name":"83c4e580","displayName":"Untitled dataset","query":"select * from samples.nyctaxi.trips"}],"pages":[{"name":"01196151","displayName":"Untitled page","layout":[{"widget":{"name":"d8458fcd","queries":[{"name":"main_query","query":{"datasetName":"83c4e580","fields":[{"name":"pickup_zip","expression":"`pickup_zip`"},{"name":"avg(trip_distance)","expression":"AVG(`trip_distance`)"}],"disaggregated":false}}],"spec":{"version":3,"widgetType":"bar","encodings":{"x":{"fieldName":"pickup_zip","scale":{"type":"categorical","sort":{"by":"y-reversed"}},"displayName":"pickup_zip"},"y":{"fieldName":"avg(trip_distance)","scale":{"type":"quantitative"},"displayName":"Average trip_distance"}},"frame":{"title":"Average Trip Distance by Pickup Zip Code","showTitle":true}}},"position":{"x":0,"y":0,"width":3,"height":6}},{"widget":{"name":"d9fe82ed","queries":[{"name":"main_query","query":{"datasetName":"83c4e580","fields":[{"name":"dropoff_zip","expression":"`dropoff_zip`"},{"name":"sum(fare_amount)","expression":"SUM(`fare_amount`)"}],"disaggregated":false}}],"spec":{"version":3,"widgetType":"bar","encodings":{"x":{"fieldName":"dropoff_zip","scale":{"type":"categorical","sort":{"by":"y-reversed"}},"displayName":"dropoff_zip"},"y":{"fieldName":"sum(fare_amount)","scale":{"type":"quantitative"},"displayName":"Sum of fare_amount"}},"frame":{"title":"Total Fare Amount by Dropoff Zip Code","showTitle":true}}},"position":{"x":3,"y":0,"width":3,"height":6}},{"widget":{"name":"c395e611","queries":[{"name":"main_query","query":{"datasetName":"83c4e580","fields":[{"name":"hourly(tpep_pickup_datetime)","expression":"DATE_TRUNC(\\"HOUR\\", `tpep_pickup_datetime`)"},{"name":"avg(fare_amount)","expression":"AVG(`fare_amount`)"}],"disaggregated":false}}],"spec":{"version":3,"widgetType":"bar","encodings":{"x":{"fieldName":"hourly(tpep_pickup_datetime)","scale":{"type":"temporal"},"displayName":"tpep_pickup_datetime"},"y":{"fieldName":"avg(fare_amount)","scale":{"type":"quantitative"},"displayName":"Average fare_amount"}},"frame":{"title":"Average Fare Amount by Hour of Pickup","showTitle":true}}},"position":{"x":3,"y":6,"width":3,"height":6}},{"widget":{"name":"9b292954","queries":[{"name":"main_query","query":{"datasetName":"83c4e580","fields":[{"name":"hourly(tpep_pickup_datetime)","expression":"DATE_TRUNC(\\"HOUR\\", `tpep_pickup_datetime`)"},{"name":"count(trip_distance)","expression":"COUNT(`trip_distance`)"}],"disaggregated":false}}],"spec":{"version":3,"widgetType":"bar","encodings":{"x":{"fieldName":"hourly(tpep_pickup_datetime)","scale":{"type":"temporal"},"displayName":"tpep_pickup_datetime"},"y":{"fieldName":"count(trip_distance)","scale":{"type":"quantitative"},"displayName":"Count of trip_distance"}},"frame":{"title":"Number of Trips by Hour of Pickup","showTitle":true}}},"position":{"x":0,"y":6,"width":3,"height":6}}]}]}'

    dash = w.lakeview.create(display_name=dash_id, serialized_dashboard=content)
